...
@app.route('/flask/copy', methods=['POST'])
@cross_origin(supports_credentials=True)
def duplicate_list():
...
@app.route('/flask/listdata', methods=['GET'])
@cross_origin(supports_credentials=True)
def list_info():
...
@app.route('/flask/addnote', methods=['POST'])
@cross_origin(supports_credentials=True)
def add_to_list():
...
@app.route('/flask/deletenote', methods=['POST'])
@cross_origin(supports_credentials=True)
...
@app.route('/flask/getlist', methods=['POST'])
@cross_origin(supports_credentials=True)
def get_list():
    id = request.get_json()
...
@app.route('/flask/complete', methods=['POST'])
@cross_origin(supports_credentials=True)
def mark_complete():
    listID, noteID = request.get_json()
    cList = TaskList.query.filter_by(id=listID).first()
...
@app.route('/flask/incomplete', methods=['POST'])
@cross_origin(supports_credentials=True)
def mark_incomplete():
    listID, noteID = request.get_json()
    cList = TaskList.query.filter_by(id=listID).first()
...
@app.route('/flask/premade', methods=['POST'])
@cross_origin(supports_credentials=True)
def premade():
    listID = request.get_json()
    cList = TaskList.query.filter_by(id=listID).first()
